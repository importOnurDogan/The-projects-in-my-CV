...
{
    public partial class ReportMealTotal : Form
    {
        MealRepository mealRepository = new MealRepository();
        int _userId;
        DateTime _date;
        public ReportMealTotal()
        {
            InitializeComponent();
        }
        ...
        private void btnMonth_Click(object sender, EventArgs e)
        {
            ...
            var result = mealRepository.GetTotalCaloriesForAllUserMonth(_date);
        ...
        {
            DataGridViewHelper.ResetDataGridView(dataGridView1);
            var result = mealRepository.GetTotalCaloriesForAllUserWeek(_date);
            dataGridView1.DataSource = result;
        ...
        public void UserInformation(int userID, DateTime date)
        {
            _userId = userID;
            _date=date;
            var result = mealRepository.GetTotalCaloriesForAllUser();
            dataGridView1.DataSource = result;
